  ...
  return (
    <Link
      ...
      className={cn(
        ...
        "shadow-brutal-md dark:shadow-[5px_5px_0_#44403c]",
        "hover:translate-x-[-2px] hover:translate-y-[-2px]",
        "hover:shadow-brutal-hover dark:hover:shadow-[6px_6px_0_#44403c]",
        "active:translate-x-[1px] active:translate-y-[1px]",
        "active:shadow-brutal-active dark:active:shadow-[2px_2px_0_#44403c]",
