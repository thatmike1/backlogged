...
function GameCardSkeleton() {
  return (
    <div className="bg-white dark:bg-stone-800 border-3 border-black dark:border-stone-600 rounded-lg overflow-hidden shadow-brutal-md dark:shadow-[5px_5px_0_#44403c]">
